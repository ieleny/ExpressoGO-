<%-- 
    Document   : Cadastro
    Created on : 14/05/2016, 23:13:23
    Author     : ieleny
--%>
     ...
     <div class="reponsivo">
	    ...
	    <a class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
          ...
          <ul class="col-sm-3 col-md-3 nav navbar-nav navbar-right">
              <li class="active"><a href="Cadastro.jsp"><span class="glyphicon glyphicon-user" ></span> Cadastro </a></li>
         ...
         <div class = "Conteudo">
             ...
             <h5 align="center" > Só precisamos de alguns minutos para fazer seu cadastro </h5>
             ...
             <div class="caixinha">
                 ...
                 <form action="" method="post">
                     ...
                     <div class="form-group text-success texto">
                         
                         <h3> Nome:&nbsp; 
		          <input type="text" id="element-3" class="input-lg" placeholder="Coloque seu Nome" name="Nome">
                         </h3>
                     </div>
                   ...
                   <br><br>
                <a class="btn btn-primary btn-lg Centrobotão "> Concluir o Cadastro </a>
